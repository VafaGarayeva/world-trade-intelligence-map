...
{ key: "Freight Containers", change: "+31.2%", cls: "red-text" }, 
...
document.getElementById("global-score-num").innerHTML = `${data.score}<span 
class="small-total">/100</span>`; 
...
data.feed.forEach(f => { 
feedHtml += `<div class="feed-item"><span>[${timeStr}]</span>        
}); 
